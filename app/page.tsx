...
export default function Home() {
  ...
  return (
    <>
      ...
      <section className="min-h-screen bg-gradient-to-br from-mf-blue/20 to-mf-blue/10 py-16 md:py-20 px-4">
        <motion.div 
          className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 xl:gap-16 items-center"
          initial={{ opacity: 0 }}
        ...
        >
          {/* Instagram Image */}
          <div className="order-2 lg:order-1 max-w-sm md:max-w-md mx-auto w-full">
            <div className="instagram-border rounded-2xl transform hover:scale-105 transition-transform duration-300">
              <div className="bg-white rounded-2xl p-6 md:p-8 text-center">
                <svg className="w-12 h-12 md:w-14 md:h-14 mx-auto mb-4" fill="currentColor" viewBox="0 0 24 24">
          ...
          {/* Introduction Text */}
          <motion.div 
            className="order-1 lg:order-2 text-center lg:text-left px-4 md:px-0"
